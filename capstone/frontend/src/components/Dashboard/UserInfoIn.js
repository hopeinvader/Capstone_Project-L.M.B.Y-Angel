...
export class UserInfo extends React.Component {
    ...
    // afterAddUsertoDB = (props) => {
    //     console.log('working here?')
    //     if(this.props.addUserB){
    //       this.setState({
    //         visible2: true
    //       });
    //       this.props.addUserFinished();
    //     }
    //     // if(this.props.isAuthenticated && this.props.enOrIn){
    //     //   props.history.push('/entrepneurs/getstart');
    //     // }
    //     // if(this.props.isAuthenticated && !this.props.enOrIn){
    ...
    testRenderAlert = (props) => {
        console.log(this.props.addUserB)
        return (
    ...
    render(){
          ...
          <div className="container">
            ...
            <div className="socialMenu">
              ...
              {/* <div className="align-self-end">
                <a className="btn btn-white btn-icon mr-3" data-toggle="modal" data-target="#model__facebook">
                  <i className="fa fa-facebook" />
                </a>
                <a className="btn btn-white btn-icon mr-3" data-toggle="modal" data-target="#model__twitter">
        ...
        {/* <section className="header-3" style={{position: 'sticky', top: '567px'}}>
          <div className="container h-100">
            <div className="row align-items-end h-100">
              <div className="col-md-8 col-lg-8 col-xl-7">
                <div className="d-flex justify-content-between align-items-end h-100 mb-2">
                  <div className="achievement d-flex align-items-end">
                    <span className="title mb-1 mr-2">応募金額</span>
                    <span className="value">
                      26,100,000円
                    </span>
                  </div>
                  <div className="d-flex flex-column">
                    <div className="target d-flex justify-content-between align-items-end mb-1">
                      <span className="title mr-2">目標募集額</span>
                      <span className="value">16,000,000円</span>
                    </div>
                    <div className="target d-flex justify-content-between align-items-end h-100">
                      <span className="title mr-2">上限応募額</span>
                      <span className="value">44,000,000円</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 offset-xl-1 col-xl-4">
                <div id="applicant">
                </div>
              </div>
            </div>
        ...
        {/* <div id="applicant_modal" className="modal fade" tabIndex={-1} />
        <div id="order_wait_modal" className="modal fade" tabIndex={-1} /> */}
          <div className="container">
          <div class="cc-pitchHead__statsMain">
              ...
              {/* Target Amount: {this.state.targetAmount} HKD   Minimum Amount: {this.state.minimumAmount} HKD */}
          {/* might need to put target minimum amount here */}
          </div>
